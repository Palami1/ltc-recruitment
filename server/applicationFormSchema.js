const FORM_20 = {
  ...
  fields: [
    ...
    { id: 'applicant_signature', type: 'file_signature', label: 'ຮູບລາຍເຊັນ', pageIndex: 1, x: 35, y: 210, maxWidth: 150, maxHeight: 45, section: '13. ເອກະສານ ແລະ ການຢືນຢັນ', required: true },
